...
#include "LCDWindow.h"
#include "LCDClock.h"
//DRN: Not used: #include "ClockThread.h"
       ...
       : wxFrame((wxFrame *)NULL, -1, title, pos, size, style)
{
    ...
    wxMenu *helpMenu = new wxMenu(wxT(""), wxMENU_TEAROFF);
...
// event handlers
void TestdcFrame::OnQuit(wxCommandEvent& WXUNUSED(event))
{
    // TRUE is to force the frame to close
    Close(TRUE);
}

void TestdcFrame::OnAbout(wxCommandEvent& WXUNUSED(event))
{
...
void MyPanel::OnBitButton(wxCommandEvent& WXUNUSED(event))
{
    wxString msg;
...
void MyPanel::OnLinearRegChange(wxCommandEvent& WXUNUSED(event))
{
	wxString val ;

	val.Printf(wxT("%d"), linearreg->GetVal()) ;

	mLinearLCD->SetValue(val) ;
}

void MyPanel::OnAngRegChange(wxCommandEvent& WXUNUSED(event))
{
	wxString val ;
...
void MyPanel::OnToggle(wxCommandEvent& WXUNUSED(event))
{
...
/////////////////////////////////////////////////////////////////////////////////////
	...
	m_angulartext = new wxStaticText(this, -1,wxT("AngularMeter"), wxPoint(120,10), wxDefaultSize,0, wxT("Label")) ;


	//Angular Meter
	angularmeter = new kwxAngularMeter(this, -1, wxPoint(50,30), wxSize(200,200) );
...
//	angularmeter->UseNeedle(false) ;
	...
	m_lineartext = new wxStaticText(this, -1,wxT("LinearMeter"), wxPoint(278,10), wxDefaultSize,0, wxT("Label")) ;


	//Linear Meter
	linearmeter = new kwxLinearMeter(this,-1, wxPoint(280,30), wxSize(50,200) );

	linearmeter->SetLabel(wxT("Test")) ;
	...
	m_displaytxt = new wxStaticText(this, -1,wxT("LCDDisplay"), wxPoint(25,230), wxDefaultSize,0, wxT("Label")) ;
	...
	m_lcdtext = new wxStaticText(this, -1,wxT("LCDClock"), wxPoint(190,230), wxDefaultSize,0, wxT("LCDClock")) ;
	...
	m_switchtxt = new wxStaticText(this, -1,wxT("BmpSwitcher"), wxPoint(113,300), wxDefaultSize,0, wxT("Label")) ;


	//Bmp Switcher
	bmpswitcher = new kwxBmpSwitcher(this, -1, wxPoint(110,315), wxSize(60,60) ) ;
	bmpswitcher->SetLabel(wxT("Test")) ;
	...
	wxButton *m_button ;
	m_button = new wxButton(this, 5, wxT("Toggle Bitmap"), wxPoint(20,330), wxDefaultSize) ;
...
/////////////////////////////////////////////////////////////////////////////////////
	...
	m_lineregtxt = new wxStaticText(this, -1,wxT("LinearRegulator"), wxPoint(380,10), wxDefaultSize,0, wxT("Label")) ;

	wxStaticText *m_angregtxt ;
	m_angregtxt = new wxStaticText(this, -1,wxT("AngularRegulator"), wxPoint(510,27), wxDefaultSize,0, wxT("Label")) ;

	linearreg = new kwxLinearRegulator(this,IDB_LINEARREG, wxPoint(390,30), wxSize(50,200), wxBORDER_NONE );
	linearreg->SetLabel(wxT("Test")) ;
...
*/
	...
	angularreg = new kwxAngularRegulator(this,IDB_ANGREG, wxPoint(500,50), wxSize(100,100), wxBORDER_NONE );
...
//	angularreg->AddTag(70) ;
	...
	m_focustxt = new wxStaticText(this, -1,wxT("BmpCheckBox"), wxPoint(510,220), wxDefaultSize,0, wxT("Label")) ;


	focusbtn = new kwxBmpCheckBox(this, IDB_BITBUTTON, *on,*off,*onsel,*offsel, wxPoint(510,240), wxSize(83,30) , wxBORDER_NONE);


	focusbtn->SetLabel(wxT("Test")) ;
...
//	wxBitmap *koan = new wxBitmap(submit_green_xpm);
	...
	wxStaticText *m_url ;
	m_url = new wxStaticText(this, -1,wxT("http://www.koansoftware.com"), wxPoint(5,436), wxDefaultSize,0, wxT("Label")) ;
